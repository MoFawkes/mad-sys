...
public sealed record WeekScheduleRow(Guid Id, [property: JsonPropertyName("org_id")] Guid OrganizationId, int Weekday, Guid? TimetableId, Guid? AudienceClassId = null);
